        ...
        loop(i, N)
        {
                ...
                loop(j, SZ(primes))
                {
                        ...
                        if( (num % primes[j]) == 0 )
                        {
                                ...
                                if( visited[ primes[j] ] == cc )
                                {
                                        result[i] = MAX(result[i], result[ lastSeen[ primes[j] ] ]);
                                }
                                else
                                {
                                        visited[ primes[j] ] = cc;
                ...
                if( num != 1 )
                {
                        if(visited[num] == cc)
                        {
                                result[i] = MAX(result[i], result[ lastSeen[num] ]);
                        }
                        else
                        {
                                visited[num] = cc;
