...
#define mypair pair<ll, bool>

inline mypair fast(ll a, int p, double limit)
{
    mypair ret;
    ret.sc = false;
...
ll lowerRoot(ll num, int k, ll hi)
{
        ll low = 1;
        ll mid;
...
ll upperRoot(double num, int k, ll hi)
{
        ll low = 1;
        ll mid;
