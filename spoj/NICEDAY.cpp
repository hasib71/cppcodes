...
void solve()
{
        ...
        loop( i, N )
        {
                if( query( 1, 1, N, 1, students[i].sc.fr  ) > students[i].sc.sc )
                {
                        ret++;
                }

                update( 1, 1, N, students[i].sc.fr, students[i].sc.sc );
        }
...
int main ()
{
    ...
    while( kases-- )
    {
        ...
        loop( i, N )
        {
                sf( "%d %d %d", &students[i].fr, &students[i].sc.fr, &students[i].sc.sc );
        }
