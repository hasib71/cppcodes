...
int main ()
{
    ...
    loop(i, N)
    {
            sf("%lld %lld", &source[i].fr, &source[i].sc);
    }

    loop(i, M)
    {
            sf("%lld %lld", &targets[i].fr, &targets[i].sc);
    }
    ...
    loop(i, N)
    {
            loop(j, M)
            {
                    dist[i][j] = sq(source[i].fr - targets[j].fr) + sq(source[i].sc - targets[j].sc);
            }
    }
