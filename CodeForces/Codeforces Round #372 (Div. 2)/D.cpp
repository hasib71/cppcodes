...
void solve()
{
        ...
        else if(dist[target] == L)
        {
                ...
                loop(i, SZ(edges))
                {
                        u = edges[i].fr;
                        v = edges[i].sc;
                        pf("%d %d %lld\n", edges[i].fr, edges[i].sc, weights[u][v]);
                }
        }
        else
        {
                ...
                else 
                {
                        ...
                        while(true)
                        {
                                ...
                                if(f)
                                {
                                        weights[u][v] = weights[v][u] = 1 + L - dist[target];
                                        f = false;
                                }
...
int main ()
{
    ...
    sf("%d %d %lld %d %d", &N, &M, &L, &source, &target);
