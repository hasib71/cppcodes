...
void job(vector<pall>&v, int st, int ed)
{
    //debug(st, ed);
    ll A = 0, B = 0;
    ...
    result = (result + A)%MOD;                                 /// possible
}

void getsum(vector<pall> &v)
{
    ...
    loop(i, N)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                while(SZ(S) > 0 && S.top().fr < snakes[i].fr)
                {
                    v.pb(S.top());
                    S.pop();
                }
...
int main ()
{
    ...
    while(kases--)
    {
        ...
        loop(i, N)
        {
            sf("%lld %lld", &snakes[i].fr, &snakes[i].sc);
        }
