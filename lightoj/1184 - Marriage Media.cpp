...
int solve()
{
        ...
        loop(i, cntMan)
        {
                loop(j, cntWoman)
                {
                        if(ABS(man[i].height - woman[j].height) <= 12 && ABS(man[i].age - woman[j].age) <= 5 && (man[i].isDivorced == woman[j].isDivorced))
                        {
                                kuhn.adj[i].pb(j);
                        }
                }
...
int main()
{
        ...
        while(kases--)
        {
                sf("%d %d", &cntMan, &cntWoman);

                loop(i, cntMan)
                {
                        sf("%d %d %d", &man[i].height, &man[i].age, &man[i].isDivorced);
                }

                loop(i, cntWoman)
                {
                        sf("%d %d %d", &woman[i].height, &woman[i].age, &woman[i].isDivorced);
                }
