...
void genarate()
{
        int originalSize = getRand(5, 15);
        int modSize = originalSize + getRand(2, 5);
        ...
        loop(i, 100)
        {
                swap( v[ getRand(2, modSize-1) ], v[ getRand( 2, modSize-1) ] );
        }
